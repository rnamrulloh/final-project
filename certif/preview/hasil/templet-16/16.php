...
<body>
    ...
    <div class="preview-container">
        <div class="preview-inner">
            <div class="preview-left">
                <img src="../../../images/16.jpg" alt="Template Sertifikat 16" class="preview-image">
            </div>
            <div class="preview-right">
                <h2>Black Gold Modern Elegant Certificate of Competition Certificate </h2>
    ...
    <div class="certificate-card">
            <a href="../templet-16/16.php">
                <img src="../../../images/15.jpg" alt="Sertifikat 15">
            <h5>Black Gold Modern Elegant Certificate of Competition Certificate</h5>
            <br>
    ...
    <div class="certificate-card">
            <a href="../templet-15/15.php">
                <img src="../../../images/15.jpg" alt="Sertifikat 15">
            <h5>MGreen And Gold Modern Certificate Of Appreciation A4 Landscape</h5>
            <br>
            <button  type="input" class="btn btn-primary">Gunakan Template Ini</button>
            </a>
        </div>
    ...
    <div class="certificate-card">
            <a href="../templet-14/14.php">
                <img src="../../../images/14.jpg" alt="Sertifikat 14">
            <h5>Merah Dan Putih Modern Sertifikat Penghargaan 17 Agustus Certificate</h5>
            <br>
            <button  type="input" class="btn btn-primary">Gunakan Template Ini</button>
            </a>
        </div>
